    ...
    public class CommentActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl("http://10.24.30.145:3000/api/") // Update with your API base URL
            ...
            btn_postcomment.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    SharedPreferences prefs = getSharedPreferences("luuidcomic", MODE_PRIVATE);
                    SharedPreferences.Editor editor = prefs.edit();
                    editor.putString("currentcomicid", comicId); // Replace "get_id()" with the actual ID field name
                    editor.apply();
